...
<header class="header-bar mb-3">
    <div class="container d-flex flex-column flex-md-row align-items-center p-3">
        ...
        <form action="/loginuser" method="POST" class="mb-0 pt-2 pt-md-0">
            @csrf
...
<div id="alertMessages">
    @if (session()->has('success'))
        <div class="container container--narrow successMessage">
...
<footer class="border-top text-center small text-muted py-3">
    <p class="m-0">Copyright &copy; {{date('Y')}} <a href="/" class="text-muted">MittaGitsch</a>. All rights reserved.</p>
</footer>

<script>
    var alertMessages = document.getElementById('alertMessages');
    var alertElement = alertMessages.querySelector('.alert');
